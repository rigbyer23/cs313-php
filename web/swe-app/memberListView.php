                ...
                <table class="table">
                    <?php
                            foreach ($members as $member){
                                ...
                                var_dump($id);
                                if($type == 'allMembers'){
                                echo '<tr><td>'.$member['id'].'</td><td>'.$member['first_name'].'</td><td> '.$member['last_name'].'</td><td> '.$member['email']. '</td><td>' .$member['phone']. '</td><td>'. $member['abbr'].'</td><td><input class ="btn-outline-danger" type="submit" value="Remove"><a href="./deleteMember.php?id="'.$id.'">Delete</a></td></tr>';
                                }
